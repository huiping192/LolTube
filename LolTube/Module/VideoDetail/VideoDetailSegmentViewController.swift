...
class VideoDetailSegmentViewController: UIViewController {
    ...
    func updateWithChannelId(_ channelId: String, channelTitle: String) {
        ...
        self.viewModel.updateWithSuccess({[weak self]() -> Void in
            ...
            let imageOperation: Operation = UIImageView.asynLoadingImage(withUrlString: weakSelf.viewModel.channelThumbnailImageUrl, secondImageUrlString: nil, needBlackWhiteEffect: false, success: {image in
