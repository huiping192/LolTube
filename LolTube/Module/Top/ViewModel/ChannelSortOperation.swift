...
class ChannelSortOperation: Operation {
    ...
    override func main() {
        ...
        let sortedChannelList = channelList.sorted {
            ...
            guard let video1PublishedAt = video1.publishedAt, let video2PublishedAt = video2.publishedAt,let video1PublishedDate = Date.date(iso8601String: video1PublishedAt), let video2PublishedDate = Date.date(iso8601String: video2PublishedAt) else {
                return false
            }
